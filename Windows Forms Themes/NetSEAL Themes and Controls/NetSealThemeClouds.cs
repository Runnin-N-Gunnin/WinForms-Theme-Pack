...
class NSProgressBar : Control
{
    ...
    protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
    {
        ...
        if (I1 > 1)
        {
            ...
            GB2 = new LinearGradientBrush(R2, Color.FromArgb(236, 240, 241), Color.FromArgb(150, 110, 0), 90f);
...
class NSLabel : Control
{
    ...
    public NSLabel()
    {
        ...
        B1 = new SolidBrush(Color.FromArgb(236, 240, 241));
    }
...
class NSTabControl : TabControl
{
    ...
    public NSTabControl()
    {
        ...
        B3 = new SolidBrush(Color.FromArgb(236, 240, 241));
...
class NSOnOffBox : Control
{
    ...
    public NSOnOffBox()
    {
        ...
        B4 = new SolidBrush(Color.FromArgb(236, 240, 241));
...
class NSTrackBar : Control
{
    ...
    protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
    {
        ...
        GB2 = new LinearGradientBrush(R3, Color.FromArgb(236, 240, 241), Color.FromArgb(150, 110, 0), 90f);
